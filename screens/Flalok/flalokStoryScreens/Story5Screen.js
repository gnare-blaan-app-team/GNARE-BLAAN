...
import Story5_FL_THUMBNAIL from '../flalokImages/Story5_FL_THUMBNAIL.png';
import Story5_EN_THUMBNAIL from '../flalokImages/Story5_EN_THUMBNAIL.png';
        ...
        return(
           <ImageBackground style={styles.imageStoryScreen} source={Flalok_BG}>
                ...
                <View style={styles.storyTitleContainer}>
                    <Image style={styles.storyTitle} source={Story5} />
                </View>
                ...
                <View style={styles.storiesContainer}>
                    <View style={styles.thumbnailContainer}>
                        <TouchableOpacity onPress={()=>{this.setState({
                            ...
                            <Image source={Story5_FL_THUMBNAIL}  style={styles.thumbnail}/>
                        </TouchableOpacity>
                    </View>
                    ...
                    <View style={styles.thumbnailContainer}>
                        <TouchableOpacity onPress={()=>{this.setState({
                            ...
                            <Image source={Story5_EN_THUMBNAIL}  style={styles.thumbnail}/>
                        </TouchableOpacity>
                    </View>
                </View>
