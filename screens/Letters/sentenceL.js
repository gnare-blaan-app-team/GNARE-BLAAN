...
class SentenceL extends Component {
    ...
    componentDidMount() {
        this.forceUpdate();
        this.letter_sentence_l = new Sound('sentence_letter_l.mp3', Sound.MAIN_BUNDLE, (error) => {
            if (error) {
    ...
    playAsound_2 = () => {
        this.letter_sentence_l.play();
    }

    handleBackPress = () => {
        this.letter_sentence_l.pause();
    }

    render() {
        return (
            <ImageBackground style={styles.image}
                source={require('./lettersImage/sentenceL.png')}
            >
