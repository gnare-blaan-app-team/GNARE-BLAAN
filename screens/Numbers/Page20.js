...
class Page20 extends Component {
    ...
    componentDidMount() {
        this.forceUpdate();
        this.number20 = new Sound('number_20.mp3', Sound.MAIN_BUNDLE, (error) => {
            if (error) {
    ...
    gotoSentence20 = () => {
        this.props.navigation.navigate('sentence20');
    }
    ...
    render() {
        return (
            ...
            >
                ...
                <Image
                    style={styles.main}
                    source={require('./numbersImage/20(1).png')}
                ></Image>
                ...
                <View style={styles.sentenceIconContainer}>
                    <TouchableOpacity onPress={this.gotoSentence20}>
                        <Image
...
export default withNavigation(Page20);