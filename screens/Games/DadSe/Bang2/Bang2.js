...
const combine = [
    combine1 = {
        ...
        choices3: choiceList[4],
        choices4: choiceList[0],
        answer: 671,
        description: Answer1
    },
    combine2 = {
        ...
        choices2: choiceList[3],
        choices3: choiceList[1],
        choices4: choiceList[7],
        answer: 672,
        description: Answer2
    },
    combine3 = {
    ...
    combine8 = {
        ...
        choices2: choiceList[8],
        choices3: choiceList[7],
...
class Bang2 extends Component {
    ...
    correct = async (index) => {
        ...
        await AsyncStorage.setItem(QuestionDone, value);
          if(index == 671){
            this.setState({
                answerImage: correctSatu,
                answerTop:'50%',
            })
        }
        if(index == 672){
            this.setState({
                answerImage: correctLwe,
                  answerTop:'50%',
            })
        }
        if (index == 673) {
            this.setState({
                answerImage: correctTlu,
                  answerTop:'50%',
            })
        }
        if (index == 674) {
