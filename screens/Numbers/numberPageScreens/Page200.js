...
class Page200 extends Component {
    ...
    componentDidMount() {
        this.forceUpdate();
        this.number200 = new Sound('number_200.mp3', Sound.MAIN_BUNDLE, (error) => {
            if (error) {
    ...
    gotoSentence200 = () => {
        this.props.navigation.replace('sentence200');
        this.number200.pause();
    }
    goBack = () => {
    ...
    gotoNextPage = () => {
        this.props.navigation.replace('page300');
       this.number200.pause();
    }

    goPrev = () => {
        this.props.navigation.replace('page100');
        this.number200.pause();
    }
        ...
        return (
            ...
            >
                ...
                <View style={globalStyleSheet.sentenceIconContainer}>
                    <TouchableOpacity onPress={this.gotoSentence200}>
                        <Image
...
export default withNavigation(Page200);