...
class octoberScreen extends Component {
    ...
    gotoOctober = () => {
        this.props.navigation.navigate('october');
    }
        ...
        return (
            <ImageBackground style={globalStyleSheet.image}
                ...
                <View style={styles.calendarBorder}>
                    <TouchableOpacity onPress={this.gotoOctober}>
                        <Image
                            source={octoberAsset}
...
export default withNavigation(octoberScreen);
