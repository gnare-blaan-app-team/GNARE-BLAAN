...
class TwentyTracing extends Component {
                ...
                if(this.state.dot6) {
                    if(this.state.dot9) {
                        if(this.state.dot15) {
                            ...
                            this.setState({arrayMove: [], showShaded: 1, shaded: shadedLine[1], dot10: false,
                                dot11: false, dot12: false, dot13: false, dot14: false, dot15: false,
                                showTracing2: 1, showTracing: 0, showShaded2: 0, tracing2: trace3});
                        }
                    } else {
                        this.setState({arrayMove: [], showShaded: 1, dot7: false, dot8: false, 
                            dot9: false, shaded: shadedLine[0],
...
export default withNavigation(TwentyTracing);