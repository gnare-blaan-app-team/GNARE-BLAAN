...
import Story3_FL_THUMBNAIL from '../flalokImages/Story3_FL_THUMBNAIL.png';
import Story3_EN_THUMBNAIL from '../flalokImages/Story3_EN_THUMBNAIL.png';
        ...
        return(
           <ImageBackground style={styles.imageStoryScreen} source={Flalok_BG}>
                ...
                <View style={styles.storyTitleContainer}>
                    <Image style={styles.storyTitle} source={Story3} />
                </View>
                ...
                <View style={styles.storiesContainer}>
                    <View style={styles.thumbnailContainer}>
                        <TouchableOpacity onPress={()=>{this.setState({
                            ...
                            <Image source={Story3_FL_THUMBNAIL}  style={styles.thumbnail}/>
                        </TouchableOpacity>
                    </View>
                    ...
                    <View style={styles.thumbnailContainer}>
                        <TouchableOpacity onPress={()=>{this.setState({
                            ...
                            <Image source={Story3_EN_THUMBNAIL}  style={styles.thumbnail}/>
                        </TouchableOpacity>
                    </View>
                </View>
