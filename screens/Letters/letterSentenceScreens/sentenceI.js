...
class SentenceI extends Component {
    ...
    componentDidMount() {
        this.forceUpdate();
        this.letter_sentence_i = new Sound('sentence_letter_i.mp3', Sound.MAIN_BUNDLE, (error) => {
            if (error) {
    ...
    playAsound_2 = () => {
        this.letter_sentence_i.play();
    }

    handleBackPress = () => {
        this.letter_sentence_i.pause();
    }
    ...
    render() {
        return (
            <ImageBackground style={styles.image}
                source={require('../lettersImage/sentenceI.png')}
            >
