...
import Chants2_video from '../../cultureandartsVideos/Chants/dasalNgPaglingap.mp4';
...
class chants2Screen extends Component {
    
    constructor () {
        super();
        this.state = {
            changeVideo: false,
            videoFile: Chants2_video,
            opacityVideo: 1,
            opacityNext: 0,
            hideVideo: '-1200%',
            hideTabs: '-1000%',
            ...
            <ImageBackground style={videoStyle.container}>
                ...
                <View style={{position: 'absolute', width: '100%', height: '100%', top: this.state.hideStory, opacity: this.state.opacityVideo}}>
                    ...
                    <View style={{position: 'absolute', justifyContent: 'center', top: this.state.controlHide, alignItems: 'center', backgroundColor: 'rgba(0, 0, 0, 0.8)', width: '100%', height: '15%'}}>
                        <Image source={require('../../cultureandartsImages/chant2.png')} style={{width:'70%', position: 'absolute', left:'15%'}}></Image>
                    </View>
...
export default withNavigation(chants2Screen);