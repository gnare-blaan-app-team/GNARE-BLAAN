...
class decemberScreen extends Component {
    ...
    gotoDecember = () => {
        this.props.navigation.navigate('december');
    }
        ...
        return (
            <ImageBackground style={globalStyleSheet.image}
                ...
                <View style={styles.calendarBorder}>
                    <TouchableOpacity onPress={this.gotoDecember}>
                        <Image
                            source={decemberAsset}
...
export default withNavigation(decemberScreen);
