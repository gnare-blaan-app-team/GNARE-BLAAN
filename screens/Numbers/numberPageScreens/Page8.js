...
class Page8 extends Component {
    ...
    componentDidMount() {
        this.forceUpdate();
        this.number8 = new Sound('number_8.mp3', Sound.MAIN_BUNDLE, (error) => {
            if (error) {
    ...
    render() {
        return (
            ...
            >
                ...
                <Image
                    style={styles.main}
                    source={require('../numbersImage/8_.png')}
                ></Image>
                ...
                <View style={styles.sentenceIconContainer}>
                    <TouchableOpacity onPress={this.gotoSentence8}>
                        <Image
...
export default withNavigation(Page8);