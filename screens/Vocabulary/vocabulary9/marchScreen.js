...
class marchScreen extends Component {
    ...
    gotoMarch = () => {
        this.props.navigation.navigate('march');
    }
        ...
        return (
            <ImageBackground style={globalStyleSheet.image}
                ...
                <View style={styles.calendarBorder}>
                    <TouchableOpacity onPress={this.gotoMarch}>
                        <Image
                            source={marchAsset}
...
export default withNavigation(marchScreen);
