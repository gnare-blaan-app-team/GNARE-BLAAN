...
import CowBG from './vocabulary4Images/cow.png';
...
class Cow extends Component {
    ...
    componentDidMount() {
        this.forceUpdate();
        this.vocab4_cow = new Sound('vocab4_cow.mp3', Sound.MAIN_BUNDLE, (error) => {
            if (error) {
        ...
        return (
            ...
            >
                <View style={globalStyleSheet.A_Speaker_Container_2}>
                    <TouchableOpacity onPress={this.playCowsound}>
                        <Image
                            source={Speaker_icon}
