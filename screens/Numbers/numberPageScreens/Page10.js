...
class Page10 extends Component {
    ...
    componentDidMount() {
        this.forceUpdate();
        this.number10 = new Sound('number_10.mp3', Sound.MAIN_BUNDLE, (error) => {
            if (error) {
    ...
    gotoSentence10 = () => {
        this.props.navigation.navigate('sentence10');
    }
    ...
    render() {
        return (
            ...
            >
                ...
                <Image
                    style={styles.main}
                    source={require('../numbersImage/10(1).png')}
                ></Image>
                ...
                <View style={styles.sentenceIconContainer}>
                    <TouchableOpacity onPress={this.gotoSentence10}>
                        <Image
...
export default withNavigation(Page10);