...
class SentenceW extends Component {
    ...
    playAsound_2 = () => {
        this.letter_sentence_w.play();
    }

    handleBackPress = () => {
        this.letter_sentence_w.pause();
    }
    ...
    render() {
        return (
            <ImageBackground style={styles.image}
                source={require('./lettersImage/sentenceW.png')}
            >
...
export default withNavigation(SentenceW);