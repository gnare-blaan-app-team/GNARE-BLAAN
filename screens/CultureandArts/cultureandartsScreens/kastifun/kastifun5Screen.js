...
import Kastifun5_video from '../../cultureandartsVideos/Kastifun/blaanDance3.mp4';
...
class kastifun5Screen extends Component {
    
    constructor () {
        super();
        this.state = {
            changeVideo: false,
            videoFile: Kastifun5_video,
            opacityVideo: 1,
            opacityNext: 0,
            hideVideo: '-1200%',
            hideTabs: '-1000%',
...
export default withNavigation(kastifun5Screen);