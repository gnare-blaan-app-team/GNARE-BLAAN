...
import NLetter_1 from '../LettersAssets/tracingN_1.gif';
import NLetter_2 from '../LettersAssets/tracingN_2.gif';
import NLetter_3 from '../LettersAssets/tracingN_3.gif';
import NLetter_4 from '../LettersAssets/tracingN_4.gif';
import NLetter_5 from '../LettersAssets/tracingN_5.gif';

import shaded_N_1 from '../LettersAssets/shaded_N_1.png';
import shaded_N_2 from '../LettersAssets/shaded_N_2.png';
import shaded_N_3 from '../LettersAssets/shaded_N_3.png';
import shaded_N_4 from '../LettersAssets/shaded_N_4.png';
import shaded_N_5 from '../LettersAssets/shaded_N_5.png';
                        ...
                        if(this.state.dot8) {
                            if(this.state.dot10) {
                                if(this.state.dot13) {
                                    ...
                                    this.setState({arrayMove: [], dot12: false, dot11: false, dot13: false,
                                        shaded: shadedLine[3], showShaded: 1, tracing: tracingLine[4]});
                                }
                            } else {
                                this.setState({arrayMove: [], dot10: false, dot9: false, 
    ...
    render() {
        ...
        return (
            <ImageBackground source={require('../../images/BG.jpg')} style={styles.image}>
                ...
                <View style={[styles.dot, {top: screenHeight * 0.475,
                ...
                */}
                ...
                <View style={[styles.dot, {top: screenHeight * 0.448,
...
export default withNavigation(NTracing);