...
import Bang2BoardQ1 from '../../gameImages/DS_bang2Q1.png';
...
class DSBang2Question1 extends Component {
        ...
        return (
            ...
            >
                ...
                <View style={globalStyleSheet.bang1Board}>
                    <Image source={Bang2BoardQ1} style={styles.image}></Image>
                </View>
...
export default withNavigation(DSBang2Question1);