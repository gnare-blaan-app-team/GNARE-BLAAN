        ...
        return(
           <ImageBackground style={styles.image} source={require('../flalokImages/Flalok_BG.jpg')}>
                ...
                <View style={styles.container}>
                    <Image source={require('../flalokImages/Story4_FL_THUMBNAIL.png')}  style={styles.thumbnail}/>
                    <Image source={require('../flalokImages/Story4_EN_THUMBNAIL.png')}  style={styles.thumbnail}/>
                </View>
