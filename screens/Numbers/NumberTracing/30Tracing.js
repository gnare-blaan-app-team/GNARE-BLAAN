                ...
                if(this.state.dot4) {
                    if(this.state.dot8) {
                        if(this.state.dot14) {
                            ...
                            this.setState({arrayMove: [], showShaded: 1, shaded: shadedLine[1], dot12: false,
                                dot9: false, dot10: false, dot11: false, dot13: false, dot14: false,
                                showTracing2: 1, showTracing: 0, showShaded2: 0, tracing2: trace3});
                        }
                    } else {
                        this.setState({arrayMove: [], showShaded: 1, dot5: false, dot6: false, 
                            dot7: false, dot8: false, shaded: shadedLine[0],
