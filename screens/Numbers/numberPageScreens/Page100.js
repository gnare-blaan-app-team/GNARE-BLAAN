...
class Page100 extends Component {
    ...
    componentDidMount() {
        this.forceUpdate();
        this.number100 = new Sound('number_100.mp3', Sound.MAIN_BUNDLE, (error) => {
            if (error) {
    ...
    gotoSentence100 = () => {
        this.props.navigation.navigate('sentence100');
    }
    ...
    render() {
        return (
            ...
            >
                ...
                <Image
                    style={styles.main}
                    source={require('../numbersImage/100(1).png')}
                ></Image>
                ...
                <View style={styles.sentenceIconContainer}>
                    <TouchableOpacity onPress={this.gotoSentence100}>
                        <Image
...
export default withNavigation(Page100);