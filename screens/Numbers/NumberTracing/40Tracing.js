...
class FourtyTracing extends Component {
            ...
            if(this.state.dot4) {
                if(this.state.dot6) {
                    if(this.state.dot10) {
                        ...
                        this.setState({arrayMove: [], showShaded: 1, shaded: shadedLine[2], dot7: false, 
                            dot10: false, dot8: false, dot9: false,
...
export default withNavigation(FourtyTracing);