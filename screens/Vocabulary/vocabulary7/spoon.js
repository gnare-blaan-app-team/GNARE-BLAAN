...
import SpoonBG from './vocabulary7Images/spoon.png';
...
class Spoon extends Component {
    ...
    componentDidMount() {
        this.forceUpdate();
        this.vocab7_spoon = new Sound('vocab7_spoon.mp3', Sound.MAIN_BUNDLE, (error) => {
            if (error) {
        ...
        return (
            ...
            >
                <View style={globalStyleSheet.A_Speaker_Container_2}>
                    <TouchableOpacity onPress={this.playSpoonsound}>
                        <Image
                            source={Speaker_icon}
...
export default withNavigation(Spoon);
