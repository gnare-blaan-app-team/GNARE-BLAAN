...
import Story4_EN from '../flalokVideos/Story4_EN.mp4';
import Story4_FL from '../flalokVideos/Story4_FL.mp4';
import Story4 from '../flalokImages/Story4.png';
import Story4_FL_THUMBNAIL from '../flalokImages/Story4_FL_THUMBNAIL.png';
import Story4_EN_THUMBNAIL from '../flalokImages/Story4_EN_THUMBNAIL.png';
        ...
        return(
           <ImageBackground style={styles.imageStoryScreen} source={Flalok_BG}>
                ...
                <View style={styles.storyTitleContainer}>
                    <Image style={styles.storyTitle} source={Story4} />
                </View>
                ...
                <View style={styles.storiesContainer}>
                    <View style={styles.thumbnailContainer}>
                        <TouchableOpacity onPress={()=>{this.setState({
                            ...
                            <Image source={Story4_FL_THUMBNAIL}  style={styles.thumbnail}/>
                        </TouchableOpacity>
                    </View>
                    ...
                    <View style={styles.thumbnailContainer}>
                        <TouchableOpacity onPress={()=>{this.setState({
                            ...
                            <Image source={Story4_EN_THUMBNAIL}  style={styles.thumbnail}/>
                        </TouchableOpacity>
                    </View>
                </View>
...
export default withNavigation(Story4Screen);