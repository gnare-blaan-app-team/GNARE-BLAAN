...
import {globalStyleSheet as styles} from '../../globalStyleSheet/globalStyleSheet';
 ...
 class Story3Screen extends Component<Props> {
        ...
        return(
           <ImageBackground style={styles.imageStoryScreen} source={require('../flalokImages/Flalok_BG.jpg')}>
                ...
                <View style={styles.storiesContainer}>
                    <Image source={require('../flalokImages/Story3_FL_THUMBNAIL.png')}  style={styles.thumbnail}/>
                    <Image source={require('../flalokImages/Story3_EN_THUMBNAIL.png')}  style={styles.thumbnail}/>
                </View>
