...
import TransparentSfalo from '../../gameImages/correctSfalo.png';
...
import C10 from '../../gameImages/bang1A10.png';
import * as Animatable from 'react-native-animatable';
import Video from "react-native-video";

const answer1List = [TransparentNam, TransparentSfalo, TransparentSyem, TransparentFitu];

const choices = [DSB1Nam, DSB1Sfalo, DSB1Syem, DSB1Fitu];
...
class DSBang1Question3 extends Component {
    ...
    // onSave = async () => {
    //     await AsyncStorage.setItem(Finish, 'Level1Completed');
    // }
