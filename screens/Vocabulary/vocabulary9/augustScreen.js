...
class augustScreen extends Component {
    ...
    gotoAugust = () => {
        this.props.navigation.navigate('august');
    }
        ...
        return (
            <ImageBackground style={globalStyleSheet.image}
                ...
                <View style={styles.calendarBorder}>
                    <TouchableOpacity onPress={this.gotoAugust}>
                        <Image
                            source={augustAsset}
...
export default withNavigation(augustScreen);
