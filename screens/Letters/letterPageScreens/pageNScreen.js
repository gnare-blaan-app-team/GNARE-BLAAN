...
import ImageGlow from '../lettersGlow/glow-N.mp4';
import FrontImage from '../lettersImage/glow-N.png';
...
class PageN extends Component {
    ...
    gotoNextPage = () => {
        this.props.navigation.push('pageO');
        this.letter_play_n.pause();
        this.wordplay_n.pause();
    }
    ...
    goPrev = () => {
        this.props.navigation.push('pageM');
        this.letter_play_n.pause();
        this.wordplay_n.pause();
    }
