...
import Bang3BoardQ5 from '../../gameImages/DS_bang3Q5.png';
import DSB3Walu from '../../gameImages/walu.png';
...
class DSBang3Question5 extends Component {
        ...
        return (
            ...
            >
                ...
                <View style={globalStyleSheet.bang1Board}>
                    <Image source={Bang3BoardQ5} style={styles.image}></Image>
                </View>
                <View style={globalStyleSheet.ds_bang1_choice1Style}>
                    <TouchableOpacity>
                        <Image source={DSB3Walu} style={styles.image}></Image>
                    </TouchableOpacity>
                </View>
...
export default withNavigation(DSBang3Question5);