...
class novemberScreen extends Component {
    ...
    gotoNovember = () => {
        this.props.navigation.navigate('november');
    }
        ...
        return (
            <ImageBackground style={globalStyleSheet.image}
                ...
                <View style={styles.calendarBorder}>
                    <TouchableOpacity onPress={this.gotoNovember}>
                        <Image
                            source={novemberAsset}
...
export default withNavigation(novemberScreen);
