...
import ImageGlow from '../lettersGlow/glow-H.mp4';
import FrontImage from '../lettersImage/glow-H.png';
...
class PageH extends Component {
    ...
    gotoNextPage = () => {
        this.props.navigation.push('pageI');
        this.letter_play_h.pause();
        this.wordplay_h.pause();
    }
    ...
    goPrev = () => {
        this.props.navigation.push('pageG');
        this.letter_play_h.pause();
        this.wordplay_h.pause();
    }
