...
class SentenceM extends Component {
    ...
    componentDidMount() {
        this.forceUpdate();
        this.letter_sentence_m = new Sound('sentence_letter_m.mp3', Sound.MAIN_BUNDLE, (error) => {
            if (error) {
    ...
    playAsound_2 = () => {
        this.letter_sentence_m.play();
    }

    handleBackPress = () => {
        this.letter_sentence_m.pause();
    }
    ...
    render() {
        return (
            <ImageBackground style={styles.image}
                source={require('../lettersImage/sentenceM.png')}
            >
...
export default withNavigation(SentenceM);