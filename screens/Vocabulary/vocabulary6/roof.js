...
import RoofBG from './vocabulary6Images/roof.png';
...
class Roof extends Component {
    ...
    componentDidMount() {
        this.forceUpdate();
        this.vocab6_roof = new Sound('vocab6_roof.mp3', Sound.MAIN_BUNDLE, (error) => {
            if (error) {
        ...
        return (
            ...
            >
                <View style={globalStyleSheet.A_Speaker_Container_2}>
                    <TouchableOpacity onPress={this.playRoofsound}>
                        <Image
                            source={Speaker_icon}
...
export default withNavigation(Roof);