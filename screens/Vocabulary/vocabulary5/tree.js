...
import TreeBG from './vocabulary5Images/tree.png';
...
class Tree extends Component {
    ...
    componentDidMount() {
        this.forceUpdate();
        this.vocab5_tree = new Sound('vocab5_tree.mp3', Sound.MAIN_BUNDLE, (error) => {
            if (error) {
    ...
    handleBackPress = () => {
        this.vocab5_tree.pause();
    }

    playTreesound = () => {
        this.vocab5_tree.play();
    }
        ...
        return (
            ...
            >
                <View style={globalStyleSheet.A_Speaker_Container_2}>
                    <TouchableOpacity onPress={this.playTreesound}>
                        <Image
                            source={Speaker_icon}
