        ...
        return(
           <ImageBackground style={styles.imageStoryScreen} source={require('../flalokImages/Flalok_BG.jpg')}>
                ...
                <View style={styles.storiesContainer}>
                    <Image source={require('../flalokImages/Story5_FL_THUMBNAIL.png')}  style={styles.thumbnail}/>
                    <Image source={require('../flalokImages/Story5_EN_THUMBNAIL.png')}  style={styles.thumbnail}/>
                </View>
