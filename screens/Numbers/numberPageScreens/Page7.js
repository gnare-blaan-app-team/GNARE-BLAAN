...
class Page7 extends Component {
    ...
    componentDidMount() {
        this.forceUpdate();
        this.number7 = new Sound('number_7.mp3', Sound.MAIN_BUNDLE, (error) => {
            if (error) {
    ...
    gotoSentence7 = () => {
        this.props.navigation.replace('sentence7');
        this.number7.pause();
    }
    goBack = () => {
    ...
    goPrev = () => {
        this.props.navigation.replace('page6');
        this.number7.pause();
    }
        ...
        return (
            ...
            >
                ...
                <View style={globalStyleSheet.sentenceIconContainer}>
                    <TouchableOpacity onPress={this.gotoSentence7}>
                        <Image
...
export default withNavigation(Page7);