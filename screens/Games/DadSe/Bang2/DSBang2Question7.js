...
import Bang2BoardQ7 from '../../gameImages/DS_bang2Q7.png';
...
class DSBang2Question7 extends Component {
        ...
        return (
            ...
            >
                ...
                <View style={globalStyleSheet.bang1Board}>
                    <Image source={Bang2BoardQ7} style={styles.image}></Image>
                </View>
...
export default withNavigation(DSBang2Question7);