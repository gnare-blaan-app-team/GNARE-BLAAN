...
import Prayer3_video from '../../cultureandartsVideos/Prayers/eveningPrayer.mp4';
...
class prayers3Screen extends Component {
    
    constructor () {
        super();
        this.state = {
            changeVideo: false,
            videoFile: Prayer3_video,
            opacityVideo: 1,
            opacityNext: 0,
            hideVideo: '-1200%',
            hideTabs: '-1000%',
        ...
        return (
            <ImageBackground style={videoStyle.container}>
                ...
                <View style={{position: 'absolute', width: '100%', height: '100%', top: this.state.hideStory, opacity: this.state.opacityVideo}}>
                    ...
                    <Image source={require('../../cultureandartsImages/prayer3.png')} style={{width:'70%', position: 'absolute', left:'15%'}}></Image>
                    </View>
...
export default withNavigation(prayers3Screen);