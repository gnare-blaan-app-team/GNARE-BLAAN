...
class Page80 extends Component {
    ...
    componentDidMount() {
        this.forceUpdate();
        this.number80 = new Sound('number_80.mp3', Sound.MAIN_BUNDLE, (error) => {
            if (error) {
    ...
    gotoSentence80 = () => {
        this.props.navigation.replace('sentence80');
        this.number80.pause();
    }
    goBack = () => {
    ...
    gotoNextPage = () => {
        this.props.navigation.replace('page90');
        this.number80.pause();
    }
        ...
        return (
            ...
            >
                ...
                <View style={globalStyleSheet.sentenceIconContainer}>
                    <TouchableOpacity onPress={this.gotoSentence80}>
                        <Image
