...
class OneHundredTracing extends Component {
    ...
    numberTrace = (X, Y) => {
        ...
        if(!this.state.dot19 && !this.state.dot1) {
            this.setState({dot19: 
                ((X >= this.line1[1].x - scopeX && X <= this.line1[1].x + scopeX) && 
                (Y >= this.line1[1].y - scopeY && Y <= this.line1[1].y + scopeY)) ? true : false});
        ...
        if((this.state.dot2 || this.state.dot20) && !this.state.dot3) {
            this.setState({dot3: 
    ...
    ifTraced = () => {
        if(this.state.dot2 || this.state.dot20) {
            if(this.state.dot4) {
                if(this.state.dot8) {
                    if(this.state.dot12) {
    ...
    clearBoard = () => {
        this.setState({arrayMove: [], dot1: false, dot2: false, dot3: false, dot4: false, dot5: false, dot6: false,
            dot7: false, dot8: false, dot9: false, dot10: false, dot11: false, dot12: false, dot19: false, dot20: false,
