...
import RiceBG from './vocabulary4Images/rice.png';
...
class Rice extends Component {
    ...
    componentDidMount() {
        this.forceUpdate();
        this.vocab4_rice = new Sound('vocab4_rice.mp3', Sound.MAIN_BUNDLE, (error) => {
            if (error) {
        ...
        return (
            ...
            >
                <View style={globalStyleSheet.A_Speaker_Container_2}>
                    <TouchableOpacity onPress={this.playRicesound}>
                        <Image
                            source={Speaker_icon}
...
export default withNavigation(Rice);