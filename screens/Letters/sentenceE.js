...
class SentenceE extends Component {
    ...
    componentDidMount() {
        this.forceUpdate();
        this.letter_sentence_e = new Sound('sentence_letter_e.mp3', Sound.MAIN_BUNDLE, (error) => {
            if (error) {
    ...
    playAsound_2 = () => {
        this.letter_sentence_e.play();
    }

    handleBackPress = () => {
        this.letter_sentence_e.pause();
    }

    render() {
        return (
            <ImageBackground style={styles.image}
                source={require('./lettersImage/sentenceE.png')}
            >
