...
class Page9 extends Component {
    ...
    componentDidMount() {
        this.forceUpdate();
        this.number9 = new Sound('number_9.mp3', Sound.MAIN_BUNDLE, (error) => {
            if (error) {
    ...
    gotoSentence9 = () => {
        this.props.navigation.replace('sentence9');
        this.number9.pause();
    }
    goBack = () => {
    ...
    gotoNextPage = () => {
        this.props.navigation.replace('page10');
        this.number9.pause();
    }

    goPrev = () => {
        this.props.navigation.replace('page8');
        this.number9.pause();
    }
        ...
        return (
            ...
            >
                ...
                <View style={globalStyleSheet.sentenceIconContainer}>
                    <TouchableOpacity onPress={this.gotoSentence9}>
                        <Image
...
export default withNavigation(Page9);